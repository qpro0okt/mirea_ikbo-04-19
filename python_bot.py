...
def MainKey():
	""" Функция осуществляет вывод меню выбора в диалог
	    Возвращает кнопки "Погода", "Курс биткоина", "Коронавирус"
	    Взаимодействует с элементами из библиотеки vk_api
	"""
    keyboard = VkKeyboard(one_time=True)
...
def PogoKey():
	""" Функция осуществляет вывод меню погоды
	
	    Возвращает кнопки "Сейчас", "На сегодня", "На завтра", "На 5 дней", "Меню"
	    Возвращает сообщение "Показать погоду"
...
def CoronaKey():
	""" Функция осуществляет вывод меню сводки по covid-19
	
	    Возвращает кнопки "Россия", "Украина", "США", "Во всем мире", "Меню"
	    Возвращает сообщение "Показать статистику"
...
def BitcoinKey():
	""" Функция осуществляет вывод меню сводки по курсу биткоина:
	
	    Возвращает кнопки "Рублю", "Доллару", "Евро", Фунту", "Меню"
	    Возвращает сообщение "Показать курс биткоина к..."
...
def ShowWeatherDay(start,end):
	""" Функция осуществляет вывод непосредственной информации о погоде "На сегодня"
	
	    Возвращает значения параметров "Температура утром", "Давление", "Влажность", "Скорость ветра"
	    
	    Взаимодействует с элементами из библиотеки requests
	"""
    ans = []
    ans = 'УТРО\n'
...
def Weather5Day():
	""" Функция осуществляет вывод непосредственной информации о погоде "На 5 дней"
	
	    Возвращает значения параметров "Температура днём", "Температура ночью"
...
def Covid_by_country(location):
	""" Функция осуществляет вывод непосредственной сводки статистики по covid-19 в конкретной стране
	
	    Возвращает значения параметров "Данные по стране", "Население"
	    
	    Взаимодействует с элементами из библиотеки COVID19PY
	"""
